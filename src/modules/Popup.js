function showQuitPopup(scene) {
  ...
  const overlay = scene.add.rectangle(centerX, centerY, 300, 200, 0x000000, 0.7).setOrigin(0.5).setDepth(100);
...
function showCompletionPopup(scene) {
  ...
  scene.physics.pause();
  console.log("Physics paused:", scene.physics.world.isPaused);
  ...
  const overlay = scene.add.rectangle(centerX, centerY, 300, 200, 0x000000, 0.7).setOrigin(0.5).setDepth(100).setStrokeStyle(2, 0xffffff); // Add a border for visibility
...
function showPopup(scene, player, tile) {
  ...
  // Create a background overlay for the popup
  const overlay = scene.add.rectangle(centerX, centerY, 300, 200, 0x000000, 0.7).setOrigin(0.5);
